...
from sglang.srt.models.llava_onevision_1_5 import (
...
class LLaVAOnevision1_5_ImageProcessor(SGLangBaseProcessor):
    models = [LLaVAOneVision1_5_ForConditionalGeneration]
